					...
					<div class="panel panel-default sidebar-menu">
						...
						<div class="panel-heading">
							<h3 class="panel-title">
								<a>모바일 경보</a><span class="badge pull-right"></span>
							</h3>
						</div>
						...
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked category-menu">
								<li>
									<ul>
										<li class="basic"><a href="/hasom/mobilealarm/alarm.do?category=0">모바일 알람</a></li>
										<li class="basic"><a href="/hasom/mobilealarm/alarm.do?category=0">모바일 정정</a></li>
										<li class="basic"><a href="/hasom/mobilealarm/alarm.do?category=0">모바일 수위</a></li>
										<li class="basic"><a href="/hasom/mobilealarm/alarm.do?category=0">모바일 압력</a></li>
										<li class="basic"><a href="/hasom/mobilealarm/alarm.do?category=0">모바일 누수</a></li>
									</ul>
								</li>
							</ul>
						</div>
