 ...
 _________________________________________________________ -->
					<div class="panel panel-default sidebar-menu">
						...
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked category-menu">
								...
								<li><a>사료</a>
									<ul>
										<li class="basic <c:if test='${category == 0}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=0">유기농/홀리스틱</a></li>
										<li class="basic <c:if test='${category == 1}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=1">피부/피모건강</a></li>
										<li class="basic <c:if test='${category == 2}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=2">헤어볼케어</a></li>
										<li class="basic <c:if test='${category == 3}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=3">다이어트/비뇨건강</a></li>
									</ul></li>
								</c:when>
								<c:when test="${category >= 4 and category <= 7}">
								<li><a>간식</a>
									<ul>
										<li class="basic <c:if test='${category == 4}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=4">캔/파우치</a></li>
										<li class="basic <c:if test='${category == 5}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=5">저키/소시지</a></li>
										<li class="basic <c:if test='${category == 6}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=6">비스켓/트릿</a></li>
										<li class="basic <c:if test='${category == 7}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=7">캣닢/캣그라스</a></li>
									</ul></li>
								</c:when>	
								<c:when test="${category >= 8 and category <= 11}">
								<li><a>모래와 화장실</a>
									<ul>
										<li class="basic <c:if test='${category == 8}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=8">응고형 모래</a></li>
										<li class="basic <c:if test='${category == 9}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=9">흡수형 모래</a></li>
										<li class="basic <c:if test='${category == 10}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=10">화장실/패드</a></li>
										<li class="basic <c:if test='${category == 11}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=11">기타</a></li>
									</ul></li>
								</c:when>	
								<c:when test="${category >= 12 and category <= 15}">
								<li><a>장난감</a>
									<ul>
										<li class="basic <c:if test='${category == 12}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=12">공/봉제인형</a></li>
										<li class="basic <c:if test='${category == 13}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=13">레이저/낚시</a></li>
										<li class="basic <c:if test='${category == 14}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=14">막대</a></li>
										<li class="basic <c:if test='${category == 15}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=15">캣닢</a></li>
									</ul></li>
								</c:when>
								<c:when test="${category >=16 and category <= 19 }">
								<li><a>위생용품</a>
									<ul>
										<li class="basic <c:if test='${category == 16}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=16">샴푸/린스</a></li>
										<li class="basic <c:if test='${category == 17}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=17">구강관리</a></li>
										<li class="basic <c:if test='${category == 18}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=18">눈/귀/피부&피모건강</a></li>
										<li class="basic <c:if test='${category == 19}'>active</c:if>"><a href="/hasom/goods/goodsCategoryList.do?goods_category=19">브러쉬/털관리</a></li>
									</ul></li>
								</c:when>
								</c:choose>	
							</ul>
				...
				<div class="col-md-9">
					...
					<c:if test="${not empty search}">
						...
						<div class="box">
							<form action="/hasom/goods/goodsSearchList.do"
